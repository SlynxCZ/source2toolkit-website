...
- <ApiParam name="plugin" type="[IToolkitPlugin*](/docs/core-api/IToolkitPlugin)" /> — Plugin instance
...
- <ApiParam name="plugin" type="[IToolkitPlugin*](/docs/core-api/IToolkitPlugin)" /> — Owner plugin
- <ApiParam name="pListener" type="[IToolkitListener*](/docs/core-api/IToolkitPlugin)" /> — Listener instance
...
### IToolkitTransmit* Transmit()

Access transmit system (per-viewer entity visibility).
...
- <ApiParam name="module" type="[IToolkitModule*](/docs/core-api/IToolkitModule)" />
